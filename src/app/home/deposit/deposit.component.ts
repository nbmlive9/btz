...
alertType: string = '';
  pdata: any;
  constructor(private location: Location, private api:AuthUserService, private http:HttpClient, private token:TokenStorageService, private router:Router,   private fb: FormBuilder, private sanitizer: DomSanitizer){
